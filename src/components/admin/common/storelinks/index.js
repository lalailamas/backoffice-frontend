...
/**
 * Componente reutilizable para mostrar los enlaces de diferentes tiendas.
 *
 * @param {Object} props - Propiedades para personalizar los datos de la tienda.
 * @param {string} props.catalogHref - El enlace para el catálogo.
 * @param {string} props.catalogText - El texto para el enlace del catálogo.
    ...
    <div className="flex flex-col justify-center p-10 bg-[url('/img/bg-new.svg')] bg-cover bg-center bg-no-repeat h-screen text-white">
      ...
      <div className='flex flex-col bg-d-soft-white rounded-3xl gap-4 p-4 mx-auto'>
        <div className='flex justify-center'>
          <img src='/img/logo.svg' alt='Logo Despnsa ' className='mb-6 w-full p-2' />
        </div>

        <a href={catalogHref} className='btn text-xs rounded-full bg-d-dark-dark-purple border-none text-d-white hover:bg-d-soft-soft-purple hover:text-d-dark-dark-purple'>
          {catalogText}
        </a>
        <a
        ...
        <div className='flex flex-col'>
          <a
            href='https://api.whatsapp.com/send?phone=56931921360'
            className='btn text-xs rounded-full bg-d-dark-dark-purple border-none text-d-white hover:bg-d-soft-soft-purple hover:text-d-dark-dark-purple'
          >Ayuda

    ...
    <>
      <div className="flex flex-col justify-center p-10 md:flex-row bg-[url('/img/bg-new.svg')] bg-cover bg-center bg-no-repeat h-screen">
        <div className='flex justify-center'>
          <img src='/img/logoblanco.png' className='w-64' />
        </div>
        <div className=' md:rounded-t-none md:w-1/2 bg-transparent flex justify-center   md:p-0 md:items-center '>
          <div className=' flex flex-col bg-d-soft-white  rounded-42 gap-4 p-16 w-[430px] h-[676px] flex-shrink-0'>
            <div className='flex justify-center' />
            <h1 className='font-AlbertSans text-25 font-semibold leading-[109%] tracking-[0.625px]'>¡Te damos la bienvenida a Despnsa!</h1>
            <h2 className='text-center'>Regístrate para disfrutar de una experiencia de compra más simple y conveniente sin esperas ni filas</h2>

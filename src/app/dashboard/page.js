...
import {
  Card, Text, Metric, TabPanel, Grid, Title, TabGroup, TabPanels, Col, Table, TableHead, TableRow, TableHeaderCell, AreaChart,
  Select, SelectItem, Badge, BadgeDelta, TableCell, TableBody
} from '@tremor/react'
import { SignalIcon, ClockIcon } from '@heroicons/react/24/solid'
...
export default function MyComponent () {
  ...
  return (
    <div>
      <MainTitle>Dashboard General</MainTitle>

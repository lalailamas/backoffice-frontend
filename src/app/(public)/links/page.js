    ...
    <div className="flex flex-col justify-center p-10  bg-[url('/img/bg-new.svg')] bg-cover bg-center bg-no-repeat h-screen text-white">
      ...
      <div className='flex flex-col bg-d-soft-white rounded-3xl gap-4 p-2  mx-auto'>
        <div className='flex justify-center'>
          <img src='/img/logo.svg' className='mb-4 w-full p-2' />
        </div>

        <div className='flex flex-col gap-4'>
          <ButtonPrimary text='Catálogo Hernán Cortés' />
          <a href='https://youtu.be/GS9rHsi8Eps' className='btn text-xs rounded-full bg-d-dark-dark-purple border-none text-d-white hover:bg-d-soft-soft-purple hover:text-d-dark-dark-purple'>Cómo funciona Despnsa</a>

          <ButtonPrimary text='FAQ' />
          <a href='https://forms.office.com/pages/responsepage.aspx?id=xGIHpa3FOkGgXp_-FXUognIJVBkk_DJOm3bBkqA7WBdUM0xIWldMV1QzNzlONDFKTlJYNlJGOTRMVCQlQCN0PWcu' className='btn text-xs rounded-full bg-d-dark-dark-purple border-none text-d-white hover:bg-d-soft-soft-purple hover:text-d-dark-dark-purple'>Quiero sugerir un producto</a>

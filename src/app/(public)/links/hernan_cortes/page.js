      ...
      <div className='flex flex-col bg-d-soft-white rounded-3xl gap-4 p-2  mx-auto'>
        ...
        <div className='flex justify-center mt-8'>
          <ul className='flex gap-4'>
            <li>
              <a href='https://www.facebook.com/Despnsa247' className='text-white' onClick={(e) => { handleLinkClick(e) }}>
            ...
            <li>
              <a href='https://www.linkedin.com/company/despnsa247' className='text-white' onClick={(e) => { handleLinkClick(e) }}>
            ...
            <li>
              <a href='https://www.instagram.com/despnsa247' className='text-white' onClick={(e) => { handleLinkClick(e) }}>

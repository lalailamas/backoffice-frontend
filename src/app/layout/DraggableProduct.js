...
function DraggableProduct ({ product, combinedIndex, selectedLayoutDetails, quantityChangeHandler, hanldeDeleteProduct }) {
            ...
            {product
              ? (
                ...
                <section className='flex flex-col items-end justify-end w-[120px] h-[180px] border border-gray-200 rounded-lg shadow text-xs bg-white'>
                  <button className='btn-xs text-xs' onClick={() => hanldeDeleteProduct(product.productId)}>

    ...
    },
    {
      ...
      content: (
        <>
          <div className='p-5'>
            <div className='flex justify-center text-center p-5'>
              <h2 className='text-d-dark-dark-purple text-2xl font-bold'>Editar Layout</h2>
            </div>
            <h3 className='text-center'>En esta sección podrás editar o eliminar un layout</h3>

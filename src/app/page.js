      ...
      <div className=' md:rounded-t-none md:w-1/2 bg-transparent flex justify-center   md:p-0 md:items-center '>
        <div className=' flex flex-col bg-d-soft-white  rounded-3xl gap-4 p-16'>
          ...
          <div className='form-control w-full '>
            ...
            <div className='join'>
              <input value={password} onChange={(e) => setPassword(e.target.value)} type='password' placeholder='122344842-K' className='input input-bordered w-full bg-d-white rounded-2xl JOIN-ITEM  text-d-dark-dark-purple' />
